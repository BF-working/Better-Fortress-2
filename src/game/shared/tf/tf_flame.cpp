...
bool CFlameEntityEnum::EnumEntity( IHandleEntity *pHandleEntity )
{
	...
	else if ( FClassnameIs( pEnt, "func_breakable" ) || FClassnameIs( pEnt, "tf_pumpkin_bomb" ) || FClassnameIs( pEnt, "tf_merasmus_trick_or_treat_prop" ) || FClassnameIs( pEnt, "tf_generic_bomb" ) || (pEnt->m_nTFFlags & TFFLAG_FLAMMABLE) )
	{
		m_Targets.AddToTail( pEnt );
	}
...
bool CTFFlameManager::IsValidBurnTarget( CBaseEntity *pEntity ) const
{
	...
	else if ( FClassnameIs( pEntity, "func_breakable" ) || FClassnameIs( pEntity, "tf_pumpkin_bomb" ) || FClassnameIs( pEntity, "tf_merasmus_trick_or_treat_prop" ) || FClassnameIs( pEntity, "tf_generic_bomb" ) || (pEntity->m_nTFFlags & TFFLAG_FLAMMABLE) )
	{
		return true;
	}
